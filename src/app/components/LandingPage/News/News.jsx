    ...
    return (
      <div className="h-auto lg:w-1/2">
        <div className="flex flex-col">
          <div className="flex flex-row items-center lg:gap-4 mx-auto"> 
            ...
            <h2 className="text-c-yellow font-reikna lg:text-5xl">News</h2>
          ...
          <div className="w-full h-auto lg:mt-8 flex justify-end">
            <Button 
            text='READ MORE'
            isPrimary={false}
            isAction={true}
