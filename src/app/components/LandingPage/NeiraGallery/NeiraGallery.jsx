...
const NeiraGallery = () => {
  return (
    <div className='lg:mt-72 w-full bg-[#0F1112] h-auto'>
        ...
        <div className="flex flex-row items-center gap-4 mx-auto mt-20"> 
        ...
        {/* slider */}
        <div className='relative w-full lg:h-[1128px] h-[728px]  bg-[#0F1112] grid grid-rows-3 lg:gap-6  gap-2 overflow-x-hidden  m-auto  lg:py-12 py-10'>
            {/* slidetrack */}
            ...
            {/* slidetrack 2*/}
            <div className='w-[3460px] flex flex-row lg:gap-6 gap-2 -translate-x-[50%]'>
            
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[341px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic4} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[341px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic5} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[707px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic6} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[341px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic4} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[341px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic5} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[707px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic6} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
                <div className='slide-2 hover:scale-110 transform duration-300 h-full w-[341px] bg-slate-500 flex relative '><Image className='object-cover' src={Pic4} alt='galeri neira' fill={true}/><p className='absolute bottom-8 left-6'>Snorkeling Points</p></div>
        ...
        <div className='flex justify-around lg:py-20 bg-[#0F1112] mx-16 py-4'>
