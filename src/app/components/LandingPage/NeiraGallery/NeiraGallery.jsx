...
const NeiraGallery = () => {
  return (
    <div className='lg:mt-72 w-full bg-[#0F1112] h-auto'>
        <div className="flex flex-col bg-[#0F1112]">
          <div className="flex flex-row items-center lg:gap-24 mx-auto bg-[#0F1112]"> 
            
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="13" fill="none" viewBox="0 0 45 13" className="scale-[200%]">
            ...
            <h2 className="text-c-yellow font-reikna lg:text-7xl">Neira Gallery</h2>
        ...
        {/* slider */}
        <div className='relative w-full lg:h-[1128px] bg-[#0F1112] grid grid-rows-3 lg:gap-6 overflow-x-hidden  m-auto lg:py-12'>
            {/* slidetrack */}
        ...
        <div className='flex justify-around lg:py-20 bg-[#0F1112] '>
          <div className='flex flex-col lg:max-w-screen-md lg:gap-2 hover:border-white border-2 border-transparent hover:border-2 lg:p-8 lg:rounded-[30px] hover:bg-white/10 transform duration-150 hover:cursor-pointer'>
            <h2 className='font-reikna lg:text-6xl text-c-green'>Aktivitas KKN</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce tempus feugiat lacus quis bibendum. Cras sodales magna magna, quis venenatis turpis faucibus eu. Interdum et malesuada fames ac ante ipsum primis in faucibus. Morbi lacinia ultrices quam, in rhoncus justo posuere a. Praesent at varius magna.</p>
          </div>

          <div className='flex flex-col lg:max-w-screen-md lg:gap-2 hover:border-white border-2 border-transparent hover:border-2 lg:p-8 lg:rounded-[30px] text-right hover:bg-white/10  transform duration-150 hover:cursor-pointer'>
            <h2 className='font-reikna lg:text-6xl text-c-green'>Explore Banda</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce tempus feugiat lacus quis bibendum. Cras sodales magna magna, quis venenatis turpis faucibus eu. Interdum et malesuada fames ac ante ipsum primis in faucibus. Morbi lacinia ultrices quam, in rhoncus justo posuere a. Praesent at varius magna.</p>
          </div>
        </div>
