      ...
      <div className='relative w-full overflow-x-clip '>
        ...
        <div className='absolute -z-20 lg:hidden -left-72 right-0 mx-auto w-96 -top-72 scale-[60%] md:scale-[200%]'>
          ...
          <defs>
            ...
            <filter id="a" width="759.263" height="1799.71" x=".444" y=".963" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
              <feFlood floodOpacity="0" result="BackgroundImageFix"/>
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            ...
            <div key={index} className=''>
              {(entry.header === 'Travel') ?
                <svg xmlns="http://www.w3.org/2000/svg" className="lg:hidden w-7 h-7 mx-auto lg:mr-4" width="21" height="22" fill="none" viewBox="0 0 21 22">
                  <path fill="#fff" fillRule="evenodd" d="M10.158 0c-2.54 0-3.95.733-3.95.733v2.934L4.217 5.823c-.335.363-.134.97.338 1.007a74.07 74.07 0 0 0 5.603.198c1.245 0 2.343-.026 3.273-.064h-.01a3.94 3.94 0 0 1 .06 1.671 3.82 3.82 0 0 1-.63 1.526 3.46 3.46 0 0 1-1.19 1.065c-.467.25-.982.381-1.503.381-.522 0-1.036-.13-1.504-.381a3.46 3.46 0 0 1-1.19-1.065 3.82 3.82 0 0 1-.63-1.526 3.962 3.962 0 0 1 .06-1.67 69.27 69.27 0 0 1-1.149-.056 5.285 5.285 0 0 0 .021 2.162c.156.71.456 1.373.88 1.94a4.593 4.593 0 0 0 1.565 1.34 4.23 4.23 0 0 0 1.947.478c.674 0 1.339-.163 1.946-.478a4.593 4.593 0 0 0 1.566-1.34c.424-.567.724-1.23.88-1.94.155-.71.163-1.449.02-2.162a58.92 58.92 0 0 0 1.19-.08c.472-.036.674-.643.34-1.006l-1.993-2.156V.733S12.697 0 10.157 0ZM7.337 4.173 5.93 5.696c1.09.059 2.518.11 4.228.11s3.138-.051 4.227-.11L12.98 4.173V1.6l-.17-.049c-.588-.161-1.483-.33-2.651-.33-1.168 0-2.063.169-2.651.33-.06.017-.117.033-.17.05v2.57Z" clipRule="evenodd"/>
                  <path fill="#fff" fillRule="evenodd" d="m10.32 13.47 3.69 1.19 3.165-2.332a.528.528 0 0 1 .581-.035c.09.052.167.13.22.225a.65.65 0 0 1 .08.315v3.056h-1.128v-1.9l-2.257 1.663v5.126c0 .47.163.898.431 1.222h-9.89a1.92 1.92 0 0 0 .43-1.222v-5.173l-2.257-1.63v1.914H2.257v-3.056c0-.11.028-.219.08-.314a.587.587 0 0 1 .218-.225.529.529 0 0 1 .58.03l3.213 2.321 3.646-1.175a.524.524 0 0 1 .302-.007l.005.002.018.005Zm.4 1.405 2.822.91v4.993h-2.821v-5.903Zm-3.949.91 2.821-.91v5.903H6.771v-4.994Z" clipRule="evenodd"/>
                  <path fill="#fff" fillRule="evenodd" d="M1.693 18.333a.543.543 0 0 0-.4.18.638.638 0 0 0-.164.431v1.834H2.82c.15 0 .294-.065.4-.18a.638.638 0 0 0 .165-.431v-1.223a.638.638 0 0 0-.166-.432.543.543 0 0 0-.399-.179H1.693ZM0 18.944c0-.486.178-.952.496-1.296a1.63 1.63 0 0 1 1.197-.537H2.82c.45 0 .88.193 1.197.537.318.344.496.81.496 1.296v1.223c0 .486-.178.952-.496 1.296A1.63 1.63 0 0 1 2.821 22H0v-3.056Zm18.621-.61c.15 0 .293.064.399.178.106.115.165.27.165.432v1.834h-1.692a.543.543 0 0 1-.4-.18.638.638 0 0 1-.165-.431v-1.223c0-.162.06-.317.165-.432a.543.543 0 0 1 .4-.179h1.128Zm1.693.61a1.91 1.91 0 0 0-.496-1.296 1.63 1.63 0 0 0-1.197-.537h-1.128c-.45 0-.88.193-1.197.537a1.91 1.91 0 0 0-.496 1.296v1.223c0 .486.178.952.495 1.296a1.63 1.63 0 0 0 1.197.537h2.822v-3.056Z" clipRule="evenodd"/>
                </svg>
                :
                (entry.header === 'Food') ? 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="lg:hidden w-7 h-7 mx-auto lg:mr-4" width="28" height="29" fill="none" viewBox="0 0 28 29">
                  <path stroke="#fff" strokeMiterlimit="22.926" strokeWidth="1.346" d="M13.306 25.264 4.054 16.54c-.515-.486-.515-3.595 0-4.08l9.252-8.724c.515-.485.876-.485 1.39 0l9.252 8.723c.515.486.515 3.596 0 4.08l-9.252 8.725c-.515.485-.875.485-1.39 0Z" clipRule="evenodd"/>
                  <path stroke="#fff" strokeMiterlimit="22.926" strokeWidth="1.346" d="m13.516 22.002-6.448-6.08c-.359-.338-.359-2.506 0-2.844l6.448-6.08c.359-.338.61-.338.97 0l6.447 6.08c.36.338.36 2.506 0 2.844l-6.448 6.08c-.359.339-.61.339-.969 0Z" clipRule="evenodd"/>
                  <path stroke="#fff" strokeMiterlimit="22.926" strokeWidth="1.346" d="m13.725 18.74-3.645-3.436c-.203-.191-.203-1.417 0-1.608l3.645-3.436c.202-.192.345-.192.547 0l3.645 3.436c.203.191.203 1.417 0 1.608l-3.645 3.436c-.203.191-.345.191-.547 0Z" clipRule="evenodd"/>
                </svg>
                :
                (entry.header === 'Nature') ?
